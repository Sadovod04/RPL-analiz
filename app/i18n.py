...
STRINGS = {
    "ru": {
        ...
        "shap_help": (
            "Модель сравнивает игрока со «средним» из выборки. Ниже — что у него "
            "сильнее или слабее среднего и в какую сторону это двигает оценку. "
            "«До отсечки» = до 19 лет; всё, что было позже, модель не видит."
        ),
        ...
        "line_FW": "Нападение",
        "cmp_method": "Метод",
        "eff_up": "поднимает оценку",
        "eff_up_strong": "сильно поднимает оценку",
        "eff_down": "снижает оценку",
        "eff_down_strong": "сильно снижает оценку",
        "shap_raw": "Подробно: вклад каждого признака (для аналитиков)",
        "shap_axis": "Вклад в лог-шансы (0 = как у среднего игрока)",
    },
    "en": {
