...
> **Что:** ранжирование футболистов академий РФ (11–21) по вероятности закрепиться в РПЛ — топ-N шортлист с калиброванными вероятностями.
> **Стек:** Python 3.12, CatBoost, scikit-learn, Cox / Random Survival Forest, PostgreSQL, Streamlit, Pydantic, pytest, uv.
> **Результат:** сбор данных с rate-limiting, анти-leakage срез по возрасту, оценка по PR-AUC / Brier / Recall@TopK, SHAP, двуязычный дашборд.
